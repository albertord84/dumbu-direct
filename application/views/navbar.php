<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="nav navbar-header hidden-xs hidden-sm">
            <a class="navbar-brand" href="#"><?php echo $this->session->username; ?></a>
        </div>
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo site_url('promo/stats'); ?>" title="Promo delivery stats"><i class="fa fa-bar-chart" aria-hidden="true"></i></a></li>
